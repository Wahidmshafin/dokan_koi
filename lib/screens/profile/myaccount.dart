                ...
                children: [
                  ...
                  SizedBox(height: getProportionateScreenHeight(30),),
                      ElevatedButton(onPressed: (){
                        profile.doc(auth.currentUser?.uid).update({"fname": _fnameController.text,"lname": _lnameController.text,"address": _addressController.text,"phone": _phoneController.text});
                        ...
                        child: Text("Save Changes",style: TextStyle(fontSize: getProportionateScreenHeight(20)),),)
