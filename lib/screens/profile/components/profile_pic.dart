  ...
  Future getImage() async{
    ...
    try{
      ...
      try{
        ...
        await storage.ref("profile/${auth.currentUser?.uid}").putFile(File(tmp.path));
        tmpImage=await storage.ref("profile/${auth.currentUser?.uid}").getDownloadURL();
        cloud.collection("profile").doc(auth.currentUser?.uid).update({"image":tmpImage});
      }
