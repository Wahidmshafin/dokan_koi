    ...
    return Text("data");
              ...
              Padding(
                ...
                child: DefaultButton(
                  text: "Add To Cart",
                  press: () {
                    _products.add({"title": product.title, "price": product.price.toInt(), "qty":1, "images":product.images, "sid":product.id, "uid":auth.currentUser?.uid,"user":auth.currentUser?.email,});
                    print(product.id);
